"""
Data downloaded from the publication's visualization material at the following link (Supplementary Table 1)
...
def process_nibr(print_analysis=False):
    print("Processing NIBR-PDXE")
