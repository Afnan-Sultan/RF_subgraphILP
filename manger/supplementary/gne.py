"""
Three files were downloaded from the publications supplementary tables at the following link
https://www.nature.com/articles/nbt.3080#Sec27

1- cell information, supplementary table 1 ("Cell line" and "Tissue Diagnosis" columns were stored to csv file)
2- drug response for Crizotinib, supplementary table 11 ("Molecule" and "Cell line" columns were stored to a csv)
3- drug response for 5 drugs, supplementary table 13 (all cells were stored to csv file after replacing "NA" with NaN
